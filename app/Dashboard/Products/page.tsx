  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-zinc-50">
      ...
      <div className="flex flex-grow">
        <Sidepanel />
        <div className="flex-grow bg-gray-100 py-2 px-2 flex flex-col flex-shrink overflow-x-auto">
          <div className="flex max-md:flex-col max-md:gap-0 1265px:flex-col overflow-auto h-full">
            <div className="flex flex-col bg-white shadow w-full h-full">
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                <div className="flex gap-5 justify-between mt-6 mr-3 w-full max-md:flex-wrap max-md:mr-2.5 max-md:max-w-full pl-3 pr-3">
                  ...
                  <div className="flex gap-5 text-sm leading-4 text-white max-md:flex-wrap">
                    ...
                    <button className="flex gap-1.5 px-3 py-1 text-base font-light whitespace-nowrap bg-purple-500 rounded-md justify-center items-center font-Poppins md:px-3 md:py-2">
                      <Image
                        src="/add.svg"
                        width={20}
                        height={20}
              ...
              <div className="overflow-x-auto px-3 h-full">
                <table className="min-w-full divide-y divide-gray-200 h-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 overflow-x-auto overflow-y-auto">
                    <tr className="text-sm font-light text-black text-opacity-70">
