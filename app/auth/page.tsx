...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = () => {
    // Perform any login logic here, then navigate
        ...
        <div className="flex-1 flex flex-col justify-center items-center mt-8 lg:mt-0">
          <div className="w-4/5 flex flex-col justify-center items-center">
            <div className="lg:mt-0 mt-10">
              <div className="mb-8">
                <h1 className="font-Poppins text-black text-2xl lg:text-4xl font-medium mb-4">
                  Managing your baby products inventory, made easier!
                </h1>
                <p className="text-gray-500 font-Poppins text-lg font-light">
                  Login to access your dashboard, track stock levels, and ensure
                  your inventory is always up-to-date.
                </p>
              </div>
              <div className="w-9/12 mt-8">
                <h1 className="text-purple-500 font-Poppins text-2xl font-medium mb-6">
                ...
                <div className="w-full flex justify-end mb-4">
                  <Link
                    ...
                    className="text-purple-500 text-base font-medium font-Poppins"
                  >
                    Forgot password?
                  </Link>
                </div>
