...
import NotificationBox from './NotificationBox'; // Assuming NotificationBox component is in a separate file
...
const Menubar: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        ...
        !((event.target as HTMLElement).closest('.notification-content'))
      ) {
  ...
  return (
    <div className="relative">
      <div className="flex justify-between items-center px-5 py-3 bg-white border-b border-black border-opacity-10 max-md:flex-wrap gap-5 sticky top-0 z-50">
        <div className="flex items-center gap-4 text-black">
          ...
          />
          <div className="flex items-center gap-1 text-base whitespace-nowrap mr-6">
            <p className="flex-grow font-Poppins">Little</p>
            <div className="flex items-baseline">
              <p className="text-2xl font-medium text-purple-500 font-Poppins">
                S
              </p>
        ...
        <div className="flex items-center gap-5">
          <div className="relative inline-flex items-center" onClick={toggleNotification}>
            <svg
            ...
            <div
              className="absolute top-0 right-0 transform translate-x-1/4 -translate-y-0.125/4"
              ref={notificationRef}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex gap-4 items-center">
            ...
            <div className="hidden sm:flex sm:flex-col md:flex-col lg:flex-col">
              <p className="text-base text-purple-500 font-Poppins">
                Status: Active
              </p>
            ...
            <div className="hidden sm:flex items-center">
              ...
              >
                <path
                  d="M7.55007 7.20027L7.85005 6.93025L13.8501 1.56608L13.2501 0.900269L7.5501 5.99437L1.85005 0.900268L1.2501 1.56608L7.25015 6.93025L7.55007 7.20027Z"
                  fill="black"
                  fillOpacity="0.65"
                />
                <path
                  d="M7.47982 7.2783L7.55006 7.34155L7.62032 7.27831L7.92003 7.00853L7.92029 7.00829L13.9201 1.64436L13.9987 1.5741L13.9281 1.49579L13.3282 0.829981L13.2581 0.752295L13.1802 0.821978L7.5501 5.85355L1.92002 0.821977L1.84205 0.752295L1.77205 0.82998L1.17209 1.49579L1.10153 1.5741L1.18011 1.64436L7.17989 7.00829L7.18017 7.00853L7.47982 7.2783Z"
                  stroke="black"
                  strokeOpacity="0.65"
                  strokeWidth="0.21"
                />
      ...
      <NotificationBox isVisible={isNotificationVisible} />
    </div>
  );
};
