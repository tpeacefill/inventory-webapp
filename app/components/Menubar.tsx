  ...
  return (
    <div className="flex justify-between items-center px-5 py-3 bg-white border-b border-black border-opacity-10 max-md:flex-wrap gap-5">
      <div className="flex items-center gap-4 text-black">
        <Image src="/Logo.svg" alt="Logo" width={51} height={51} className="hidden md:block" />
    ...
    <div className="flex items-center sm:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path fillRule="evenodd" clipRule="evenodd" d="M4 6H20V8H4V6ZM4 11H20V13H4V11ZM4 16H20V18H4V16Z" fill="black"/>
        </svg>
    </div>
